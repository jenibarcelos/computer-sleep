...
var sleep = {
    ...
    _init: function() {
        ...
        source_mp4.setAttribute('src', 'https://github.com/zolekm/computer-sleep/blob/master/resources/muted-blank.mp4');
        source_mp4.setAttribute('type', 'video/mp4');
        this._video.appendChild(source_mp4);

        var source_ogg = document.createElement('source');
        source_ogg.setAttribute('src', 'https://github.com/zolekm/computer-sleep/blob/master/resources/muted-blank.ogv');
